...
void BaseLayer::handleMessage(cMessage* msg)
{
    ...
    EV << "mensajes a mi UABC " << msg->isSelfMessage();
...
{
    EV << "BaseLayer: eNVIA DATOS ABAJO " << std::endl;
...
{
    EV << "BaseLayer: eNVIA DATOS ARRIBA " << std::endl;
...
void BaseLayer::sendControlUp(cMessage *msg)
{
    ...
    if (gate(upperControlOut)->isPathOK())
    {
        ...
        EV << "BaseLayer: eNVIA DATOS ARRIBA2 " << std::endl;
    }
    else {
